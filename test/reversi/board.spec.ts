...
describe("Display board", function () {
    ...
    test("Should find possible moves for a player B toward top direction", function () {
        // Arrange
        const board: Board = [
            [".", ".", ".", ".", ".", ".", ".", "."],
            [".", ".", ".", ".", ".", ".", ".", "."],
    ...
    test("Should find possible moves for a player W toward top direction", function () {
        // Arrange
        const board: Board = [
            [".", ".", ".", ".", ".", ".", ".", "."],
            [".", ".", ".", ".", ".", ".", ".", "."],
        ...
        // Act
        const positions = findPossibleMoves(board, {x:3,y:4}, player);

        // Assert
        expect(positions).toEqual(expectMove);
    });

    test("Should find possible moves for a player B toward bottom direction", function () {
        // Arrange
        const board: Board = [
            [".", ".", ".", ".", ".", ".", ".", "."],
            [".", ".", ".", ".", ".", ".", ".", "."],
    ...
    test("Should find possible moves for a player W toward bottom direction", function () {
        // Arrange
        const board: Board = [
            [".", ".", ".", ".", ".", ".", ".", "."],
            [".", ".", ".", ".", ".", ".", ".", "."],
